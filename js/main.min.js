...
MakeMap.prototype = {
    ...
    !function() {
        ...
        var a = "_mouse-focused";
        $B.on("mousedown", function() {
            setTimeout(function() {
                var b = document.activeElement, c = $(b);
                b && b !== document.body && c.addClass(a).one("blur", function() {
                    c.removeClass(a);
                });
            }, 0);
        });
        ...
        a.each(function() {
            function a(a) {
                var d = c.more.text();
                a.preventDefault(), c.part.slideToggle(), b.toggleClass("_active"), c.more.text(c.more.data("alt")).data("alt", d);
            }
            var b = $(this), c = {
        ...
        a.each(function() {
            function a() {
                l = new google.maps.LatLngBounds(), $.each(i, function(a, b) {
                    ...
                    l.extend(d);
                }), h.mapObject.on("click", ".js-marker-close", function(a) {
                    a.stopPropagation(), f();
                });
            }
            function b(a, b, c) {
            ...
            function c() {
                function a() {
                    var a = k.getZoom(), e = b.filter("._in"), f = b.filter("._out");
                    b.removeClass("_disabled"), a == d && e.addClass("_disabled"), a == c && f.addClass("_disabled");
                }
                var b = h.zoom.find(".js-map-zoom-button"), c = ~~h.mapObject.data("zoomMin") || 6, d = ~~h.mapObject.data("zoomMax") || 18;
                b.on("click", function() {
                    var a = $(this), b = a.hasClass("_out") ? -1 : 1, c = k.getZoom(), d = c + b;
                    a.hasClass("_disabled") || k.setZoom(d);
                }), google.maps.event.addListener(k, "zoom_changed", a);
            }
            function d() {
        ...
        var a = $(".js-product-caro");
        a.each(function() {
            var a = $(this), b = {
                arrows: $(".js-product-caro-arrow", a),
                list: $(".js-product-caro-list", a)
            };
            b.list.bxSlider({
                minSlides: 1,
                maxSlides: 1,
                ...
                responsive: !1,
                controls: !1,
                prevSelector: b.arrows.filter("._prev"),
                nextSelector: b.arrows.filter("._next")
            });
        });
    }();
});