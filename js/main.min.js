...
MakeMap.prototype = {
    ...
    !function() {
        ...
        a.each(function() {
            function a() {
                var a = $W.height() - (d.headerHeight + d.footerHeight), e = 0;
                a < d.minArea && (a = d.minArea), b.css("minHeight", a / 10 + "rem"), e = Math.floor((a - d.descBoxHeight) / 2), 
                20 > e && (e = 20), c.descBox.css({
                    margin: e / 10 + "rem 0 2rem"
                }), d.isReady || (d.isReady = !0, b.addClass("_ready"));
            }
            var b = $(this), c = {
